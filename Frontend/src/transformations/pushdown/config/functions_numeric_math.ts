...
export const numericMathFunctions: FunctionEntry[] = [
  ...
  functionEntry(
    ...
    'Truncate decimal',
    FunctionCategory.NUMERIC_MATH,
    'Truncate / remove decimal places (different from rounding)',
    {
  ...
  functionEntry(
    ...
    'Power / Exponent',
    FunctionCategory.NUMERIC_MATH,
    'Raise number to a power (e.g., n^e)',
    {
  ...
  functionEntry(
    ...
    'Sign of number',
    FunctionCategory.NUMERIC_MATH,
    'Return -1, 0, or 1 indicating sign of number',
    {
  ...
  functionEntry(
    ...
    'Natural logarithm',
    FunctionCategory.NUMERIC_MATH,
    'Return natural logarithm (base e) of number',
    {
  ...
  functionEntry(
    ...
    'Log base 10',
    FunctionCategory.NUMERIC_MATH,
    'Return logarithm base 10 of number',
    {
