 ...
 */
import { getCapability, getUnsupportedFunctions, getNativeFunctions, } from './CapabilityMatrix';
/**
...
export class FunctionAvailabilityFilter {
     ...
     */
    filterFunctions(sourceTech, executionPoint) {
        const available = [];
        const alternatives = [];
        const unavailable = [];
        const allFunctions = [];
     ...
     */
    checkFunctionAvailability(functionId, sourceTech, executionPoint, metadata) {
     ...
     */
    getAlternative(functionId, sourceTech) {
        const capability = getCapability(functionId, sourceTech);
     ...
     */
    validateSegmentFunctions(functionIds, sourceTech, executionPoint) {
        const incompatible = [];
        const warnings = [];
 ...
 */
export function createFunctionAvailabilityFilter() {
