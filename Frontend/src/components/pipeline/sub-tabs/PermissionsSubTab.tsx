      ...
      <div className="flex items-center justify-between p-4 bg-neutral-50 border border-neutral-200 rounded-lg">
        <div>
          ...
          <div className="text-xs text-neutral-500 mt-0.5">
            {inheritFromProject
              ? 'This pipeline inherits project-level grants. Breaking inheritance creates an independent access list.'
              : 'Inheritance is broken. This pipeline has a standalone access list.'}
          </div>
        </div>
        <button
